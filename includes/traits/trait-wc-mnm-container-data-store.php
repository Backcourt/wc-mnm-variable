...
trait WC_MNM_Container_Data_Store {
	...
	/**
	 * Data stored in meta keys, but not considered "meta" for the product type.
	 *
	 * @var array
	 */
	protected $shared_extended_internal_meta_keys = array(
		'_mnm_content_source',
	 ...
	 *
	 * @param  WC_Product_Mix_and_Match|WC_Product_Mix_and_Match_Variation  $product
	 * @param  bool                   $force
	 */
